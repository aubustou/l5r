...
The_Unassailable_Fortress_of_the_Crab = Stronghold(card_id=12257, title='The Unassailable Fortress of the Crab', gold_production='4', starting_family_honor=3, province_strength=7, clan=[CrabClan], traits=[], abilities=[], legality=[TwentyFestivalsEdition, ModernEdition])