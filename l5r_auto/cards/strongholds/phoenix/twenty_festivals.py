...
The_Majestic_Temple_of_the_Phoenix = Stronghold(card_id=12261, title='The Majestic Temple of the Phoenix', gold_production='4', starting_family_honor=6, province_strength=6, clan=[PhoenixClan], keywords=[Temple], traits=[], abilities=[], legality=[TwentyFestivalsEdition, ModernEdition])