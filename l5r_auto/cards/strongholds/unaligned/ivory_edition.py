...
Gates_of_the_Second_City = Stronghold(card_id=11142, title='Gates of the Second City', gold_production='8', starting_family_honor=8, province_strength=7, clan=[Unaligned], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])