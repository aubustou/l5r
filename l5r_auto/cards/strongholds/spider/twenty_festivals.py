...
The_Hidden_Bastion_of_the_Spider = Stronghold(card_id=12262, title='The Hidden Bastion of the Spider', gold_production='4', starting_family_honor=0, province_strength=8, clan=[SpiderClan], traits=[], abilities=[], legality=[TwentyFestivalsEdition, ModernEdition])