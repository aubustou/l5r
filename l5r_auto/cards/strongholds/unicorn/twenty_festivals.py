...
The_Endless_Plains_of_the_Unicorn = Stronghold(card_id=12263, title='The Endless Plains of the Unicorn', gold_production='5', starting_family_honor=4, province_strength=7, clan=[UnicornClan], traits=[], abilities=[], legality=[TwentyFestivalsEdition, ModernEdition])