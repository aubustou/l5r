...
The_Grand_Halls_of_the_Lion = Stronghold(card_id=12260, title='The Grand Halls of the Lion', gold_production='3', starting_family_honor=7, province_strength=7, clan=[LionClan], traits=[], abilities=[], legality=[TwentyFestivalsEdition, ModernEdition])