...
Hida_Yakamo_Seven_Thunder_Experienced_2CW = Personality(card_id=12640, title='Hida Yakamo, Seven Thunder', force=6, chi=4, personal_honor=4, gold_cost=14, honor_requirement=6, clan=[CrabClan], keywords=[Experienced('2CW'), Loyal, Resilient, Tactician, Unique, ClanChampion, Commander, Hero, Jade, Samurai], traits=[], abilities=[], legality=[TwentyFestivalsEdition, OnyxEdition, ModernEdition])