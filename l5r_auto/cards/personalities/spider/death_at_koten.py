...
Suikotsu = Personality(card_id=7617, title='Suikotsu', force=4, chi=2, personal_honor=1, gold_cost=7, honor_requirement=None, clan=[SpiderClan, BrotherhoodOfShinsei], keywords=[Kensai, Monk, OrderOfVenom], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, CelestialEdition, SamuraiEdition, ModernEdition])