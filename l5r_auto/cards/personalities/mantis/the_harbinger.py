...
Tsuruchi_Gosho = Personality(card_id=8833, title='Tsuruchi Gosho', force=3, chi=3, personal_honor=1, gold_cost=7, honor_requirement=None, clan=[MantisClan], keywords=[Naval, Reserve, Samurai, Scout, Thunder], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, CelestialEdition, ModernEdition])