...
Clear_Water_Village = Holding(card_id=1418, title='Clear Water Village', gold_cost=2, keywords=[Village], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, GoldEdition, ModernEdition])
...
Roaming_Caravan = Holding(card_id=6369, title='Roaming Caravan', gold_cost=2, keywords=[Market, Retainer], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, GoldEdition, ModernEdition])