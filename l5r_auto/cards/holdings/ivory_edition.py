...
Brilliant_Cascade_Inn = Holding(card_id=11140, title='Brilliant Cascade Inn', gold_cost=1, keywords=[GeishaHouse], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])
'<b>:bow::</b> Produce 1 Gold. <br><b>:bow::</b> When paying for a Holding, it enters play for 2 less Gold.'
Deep_Harbor = Holding(card_id=11141, title='Deep Harbor', gold_cost=1, keywords=[Port], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])
...
Secluded_Shrine = Holding(card_id=11144, title='Secluded Shrine', gold_cost=1, keywords=[Temple], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])