...
Akodo_Dojo = Holding(card_id=201, title='Akodo Dojo', gold_cost=2, keywords=[Dojo], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, DiamondEdition, ModernEdition])