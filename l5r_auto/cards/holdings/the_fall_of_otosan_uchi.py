...
Carrions_Breath = Holding(card_id=1222, title="Carrion's Breath", gold_cost=2, keywords=[Shadowlands], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, GoldEdition, DiamondEdition, ModernEdition])
'<b>:bow::</b> Produce 2 Gold. <br><b>:bow::</b> When paying for an action on a Strategy, it costs 3 less Gold.'
Kaeru_Contractor = Holding(card_id=4091, title='Kaeru Contractor', gold_cost=2, traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, GoldEdition, DiamondEdition, ModernEdition])