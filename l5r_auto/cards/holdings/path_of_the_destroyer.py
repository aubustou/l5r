...
Wandering_Caravan = Holding(card_id=9203, title='Wandering Caravan', gold_cost=2, keywords=[Market, Retainer], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, CelestialEdition, ModernEdition])