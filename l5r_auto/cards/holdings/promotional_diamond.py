...
Vengeful_Populace = Holding(card_id=9138, title='Vengeful Populace', gold_cost=2, traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, LotusEdition, DiamondEdition, ModernEdition])