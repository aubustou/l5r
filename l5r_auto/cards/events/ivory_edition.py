...
Political_Standoff = Event(card_id=11139, title='Political Standoff', keywords=[Kharmic], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])