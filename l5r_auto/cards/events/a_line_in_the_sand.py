...
Abdication = Event(card_id=11544, title='Abdication', keywords=[Kharmic], traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])
...
The_Samurai_Caste_Divides = Event(card_id=11545, title='The Samurai Caste Divides', traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])
...
The_Serpent_War = Event(card_id=11546, title='The Serpent War', traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ModernEdition])