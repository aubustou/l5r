...
Victory_of_the_Thunders = Event(card_id=12586, title='Victory of the Thunders', keywords=[Unique], traits=[], abilities=[], legality=[TwentyFestivalsEdition, OnyxEdition, ModernEdition])