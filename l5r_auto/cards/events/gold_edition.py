...
Alliance = Event(card_id=331, title='Alliance', traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ImperialEdition, GoldEdition, JadeEdition, ModernEdition])
'<b>Dynasty:</b> Draw a card. <i>(You may only take Dynasty actions during your Dynasty Phase.)</i>'
Glimpse_of_the_Unicorn = Event(card_id=2818, title='Glimpse of the Unicorn', traits=[], abilities=[], legality=[IvoryEdition, TwentyFestivalsEdition, ImperialEdition, GoldEdition, JadeEdition, ModernEdition])