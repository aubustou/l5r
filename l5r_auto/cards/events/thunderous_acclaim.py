...
A_Vision_Imparted = Event(card_id=12265, title='A Vision Imparted', traits=[], abilities=[], legality=[TwentyFestivalsEdition, OnyxEdition, ModernEdition])
...
Coronation_Festival = Event(card_id=12266, title='Coronation Festival', keywords=[Kharmic, Festival], traits=[], abilities=[], legality=[TwentyFestivalsEdition, OnyxEdition, ModernEdition])
...
Exodus_of_the_Spider = Event(card_id=12267, title='Exodus of the Spider', traits=[], abilities=[], legality=[TwentyFestivalsEdition, OnyxEdition, ModernEdition])